...
<?php  
        ...
        if(isset($_GET['edit_manufacturer'])){
            ...
            $get_manufacturer = "select * from tbl_manufacturers where manufacturer_id='$edit_manufacturer'";
...
<?php  
    ...
    if(isset($_POST['update'])){
        ...
        if(is_uploaded_file($_FILES['manufacturer_image']['tmp_name'])){
            ...
            $update_manufacturer = "update tbl_manufacturers set manufacturer_title='$manufacturer_name',manufacturer_top='$manufacturer_top',manufacturer_image='$manufacturer_image'where manufacturer_id='$m_id'" ;
            ...
            $update_manufacturer = "update tbl_manufacturers set manufacturer_title='$manufacturer_name',manufacturer_top='$manufacturer_top' where manufacturer_id='$m_id'" ;
