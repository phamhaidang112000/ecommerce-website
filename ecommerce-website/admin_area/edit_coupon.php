...
if(isset($_GET['edit_coupon'])){
    ...
    $edit_coupon = "select * from tbl_coupons where coupon_id='$edit_id'";
    ...
    $get_products = "select * from tbl_products where product_id='$prod_id'";
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <select name="product_id" class="form-control" required>
                            ...
                            <?php 
                                ...
                                $get_p = "select * from tbl_products";
...
if(isset($_POST['update'])){
    ...
    $update_coupon = "update tbl_coupons set product_id='$coupon_pro_id',coupon_title='$coupon_title',coupon_price='$coupon_price',coupon_code='$coupon_code',coupon_limit='$coupon_limit',coupon_used='$coup_used' where coupon_id='$coup_id'";
