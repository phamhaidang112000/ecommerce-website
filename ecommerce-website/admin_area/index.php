<?php 
    ...
    if(!isset($_SESSION['admin_email'])){
        ...
        $get_admin = "select * from tbl_admins where admin_email='$admin_session'";
        ...
        $get_customers = "select * from tbl_customers";
        
        $run_customers = mysqli_query($conn,$get_customers);
        
        $count_customers = mysqli_num_rows($run_customers);
        
        $get_p_categories = "select * from tbl_product_categories";
        ...
        $get_pending_orders = "select * from tbl_pending_order";
...
<head>
    ...
    <title>Ecommerce Website Admin Area</title>
