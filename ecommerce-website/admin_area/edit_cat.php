...
<?php 
    ...
    if(isset($_GET['edit_cat'])){
        ...
        $edit_cat_query = "select * from tbl_categories where category_id='$edit_cat_id'";
        ...
        $cat_top = $row_edit['category_top'];
        
        $cat_image = $row_edit['category_image'];
...
<?php  
          ...
          if(isset($_POST['update'])){
              ...
              if(is_uploaded_file($_FILES['cat_image']['tmp_name'])){
                ...
                $new_cat_image = $_FILES['cat_image']['name'];
                
                $temp_name = $_FILES['cat_image']['tmp_name'];

                move_uploaded_file($temp_name ,"other_images/$new_cat_image");
                
                $update_cat = "update tbl_categories set category_title='$cat_title',category_desc='$cat_desc',category_top='$cat_top',category_image='$new_cat_image' where category_id='$cat_id'";
                ...
                $update_cat = "update tbl_categories set category_title='$cat_title',category_top='$cat_top' where category_id='$cat_id'";
