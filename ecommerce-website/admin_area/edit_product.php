...
<?php 
    ...
    if(isset($_GET['edit_product'])){
        ...
        $get_p = "select * from tbl_products where product_id='$edit_id'";
        ...
        $get_manufacturer = "select * from tbl_manufacturers where manufacturer_id='$m_id'";
        ...
        $get_p_cat = "select * from tbl_product_categories where p_cat_id='$p_cat'";
        ...
        $get_cat = "select * from tbl_categories where category_id='$cat'";
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <select name="manufacturer" class="form-control"><!-- form-control Begin -->
                              ...
                              $get_manufacturer = "select * from tbl_manufacturers";
                              $run_manufacturer = mysqli_query($conn,$get_manufacturer);
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <select name="cat" class="form-control"><!-- form-control Begin -->
                              ...
                              $get_cat = "select * from tbl_categories";
                              $run_cat = mysqli_query($conn,$get_cat);
