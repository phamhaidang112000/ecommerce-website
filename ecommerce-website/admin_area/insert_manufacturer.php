...
<?php  
    ...
    if(isset($_POST['submit'])){
        ...
        $insert_manufacturer = "insert into tbl_manufacturers (manufacturer_title,manufacturer_top,manufacturer_image) values ('$manufacturer_name','$manufacturer_top','$manufacturer_image')";
