...
if(isset($_POST['submit'])){
    ...
    $get_coupons = "select * from tbl_coupons where product_id='$coupon_pro_id' or coupon_code='$coupon_code'";
    ...
    if($check_coupons==1){
        ...
        $insert_coupon = "insert into tbl_coupons (product_id,coupon_title,coupon_price,coupon_code,coupon_limit,coupon_used)values('$coupon_pro_id','$coupon_title','$coupon_price','$coupon_code','$coupon_limit','$coupon_used')";
