...
<?php 
    ...
    if(isset($_GET['user_profile'])){
        ...
        $get_user = "select * from tbl_admins where admin_id='$edit_user'";
...
if(isset($_POST['update'])){
    ...
    $update_user = "update tbl_admins set admin_name='$user_name',admin_email='$user_email',admin_pass='$user_pass',admin_country='$user_country',admin_contact='$user_contact',admin_job='$user_job',admin_about='$user_about',admin_image='$user_image' where admin_id='$user_id'";
