...
<?php 
    ...
    if(isset($_GET['edit_box'])){
        ...
        $edit_box_query = "select * from tbl_boxes_section where box_id='$edit_box_id'";
...
<?php  
          ...
          if(isset($_POST['update_box'])){
              ...
              $update_box = "update tbl_boxes_section set box_title='$box_title',box_desc='$box_desc' where box_id='$box_id'";
