    ...
    <div class="panel-collapse collapse-data"><!-- panel-collapse collapse-data Begin -->
        ...
        <div class="panel-body scroll-menu"><!-- panel-body 2 Begin -->
            <ul class="nav nav-pills nav-stacked category-menu" id="dev-manufacturer"><!-- nav nav-pills nav-stacked category-menu Begin -->
                ...
                $get_manufacturer = "select * from tbl_manufacturers where manufacturer_top='yes'";
                ...
                $get_manufacturer = "select * from tbl_manufacturers where manufacturer_top='no'";
                $run_manufacturer = mysqli_query($conn,$get_manufacturer);
    ...
    <div class="panel-collapse collapse-data"><!-- panel-collapse collapse-data Begin -->
        ...
        <div class="panel-body scroll-menu"><!-- panel-body 2 Begin -->
            <ul class="nav nav-pills nav-stacked category-menu" id="dev-cat"><!-- nav nav-pills nav-stacked category-menu Begin -->
                ...
                $get_cat = "select * from tbl_categories where category_top='yes'";
                ...
                while($row_cat=mysqli_fetch_array($run_cat)){
                    ...
                    $cat_image = $row_cat['category_image'];
                ...
                $get_cat = "select * from tbl_categories where category_top='no'";
                $run_cat = mysqli_query($conn,$get_cat);
    ...
    <div class="panel-collapse collapse-data"><!-- panel-collapse collapse-data Begin -->
        ...
        <div class="panel-body scroll-menu"><!-- panel-body 2 Begin -->
            <ul class="nav nav-pills nav-stacked category-menu" id="dev-p-cat"><!-- nav nav-pills nav-stacked category-menu Begin -->
                ...
                $get_p_cat = "select * from tbl_product_categories where p_cat_top='yes'";
                ...
                $get_p_cat = "select * from tbl_product_categories where p_cat_top='no'";
                $run_p_cat = mysqli_query($conn,$get_p_cat);
