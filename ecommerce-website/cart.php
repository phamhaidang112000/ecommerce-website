       ...
       <div class="container"><!-- container Begin -->
           ...
           <div id="cart" class="col-md-9"><!-- col-md-9 Begin -->
               ...
               <?php 
                    ...
                    if(isset($_POST['apply_coupon'])){
                        ...
                        if($code == ""){
                            ...
                            $get_coupons = "select * from tbl_coupons where coupon_code='$code'";
                            ...
                            if($check_coupons == "1"){
                                ...
                                if($coupon_limit == $coupon_used){
                                    ...
                                    $get_cart = "select * from tbl_cart where pro_id='$coupon_pro_id' AND ip_add='$ip_add'";
                                    $run_cart = mysqli_query($conn,$get_cart);
                                    $check_cart = mysqli_num_rows($run_cart);

                                    if($check_cart == "1"){

                                        $add_used = "update tbl_coupons set coupon_used=coupon_used+1 where coupon_code='$code'";
                                        $run_used = mysqli_query($conn,$add_used);
                                        $update_cart = "update tbl_cart set p_price='$coupon_price' where pro_id='$coupon_pro_id' AND ip_add='$ip_add'";
                ...
                function update_cart(){
                    ...
                    if(isset($_POST['update'])){
                        ...
                        foreach($_POST['remove'] as $remove_id){
                            ...
                            $delete_product = "delete from tbl_cart where pro_id='$remove_id'";
               ...
               <div id="row same-heigh-row"><!-- #row same-heigh-row Begin -->
                   ...
                   $get_products = "select * from tbl_products order by rand() LIMIT 0,3";
