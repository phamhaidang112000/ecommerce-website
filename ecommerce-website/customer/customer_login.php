...
if(isset($_POST['login'])){
    ...
    $select_customer = "select * from tbl_customers where customer_email='$customer_email' AND customer_pass='$customer_pass'";
    
    $run_customer = mysqli_query($conn,$select_customer);
    
    $get_ip = get_real_ip_user();
    
    $check_customer = mysqli_num_rows($run_customer);
    
    $select_cart = "select * from tbl_cart where ip_add='$get_ip'";
